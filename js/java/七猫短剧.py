...
class Spider(Spider):
    ...
    def homeContent(self, filter):
        ...
        classes.extend([
            {"type_id": "qx_1", "type_name": "剧场"},
            {"type_id": "qx_3", "type_name": "新剧"},
            {"type_id": "qx_2", "type_name": "热播"},
            {"type_id": "qx_7", "type_name": "星选"},
            {"type_id": "qx_5", "type_name": "阳光"}
        ])
                ...
                if detail.status_code == 200:
                    ...
                    for vod in data['data']['list']:
                        videos.append({
                            ...
                            "vod_remarks": vod['theater'].get('play_amount_str', '七猫热播')
                        })
            except:
                pass
                    ...
                    if detail.status_code == 200:
                        ...
                        for vod in data['data']['list']:
                            videos.append({
                                ...
                                "vod_name": vod['theater']['title'],
                                "vod_pic": vod['theater']['cover_url'],
                                "vod_remarks": vod['theater'].get('theme', '七猫')
                            })
                except:
                    pass
                ...
                if detail.status_code == 200:
                    ...
                    for vod in data['data']['theater']['search_data']:
                        videos.append({
                            ...
                            "vod_remarks": vod.get('score_str', '七猫')
                        })
            except:
                pass
